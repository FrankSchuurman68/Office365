...
function PasswordWidget(divid,pwdname)
{
	...
	this.showing_pwd=1;
	this.txtShow = 'Laat uw wachtwoord zien';
	this.txtMask = 'Verberg uw wachtwoord';
	this.txtGenerate = 'Genereer een sterk wachtwoord';
	this.txtWeak='Een zwak wachtwoord';
	this.txtMedium='Een gewoon wachtwoord, niet sterk';
	this.txtGood='Een heel sterk wachtwoord';
